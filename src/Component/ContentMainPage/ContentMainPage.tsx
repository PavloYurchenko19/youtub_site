  ...
  return (
        <motion.div
            ...
            <div className={style.content__bottom}>
                <h2 id={'#lorem'}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A adipisci aliquam consectetur deserunt distinctio dolorem eaque hic illum ipsam mollitia natus numquam placeat porro quo rem, sequi tempora tempore tenetur.</h2>
            </div>
